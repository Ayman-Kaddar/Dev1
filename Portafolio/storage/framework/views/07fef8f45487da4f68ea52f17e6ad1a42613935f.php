...
<section class="contenedormenu">
    ...
    <section class="experiencia" id="xp">
      ...
      <a href=""><img class="card-img-top" src="<?php echo e(asset('img/Login.png')); ?>"/></a>
        <div class="card-body">
          <h5 id="title-lavado" class="card-title">DevChallenge2</h5>
        </div>
      </div>
      <div id="side-2" class="slide card">    
        <a href=""><img class="card-img-top" src="<?php echo e(asset('img/')); ?>"/></a>
        <div class="card-body">
      ...
      <div id="side-5" class="slide card">
        <a href="https://github.com/Ayman-Kaddar/FINAL-FINAL-PLANGYM"><img class="card-img-top" src="<?php echo e(asset('img/PlanGym.png')); ?>"/></a>
        <div class="card-body">
          <h5 id="title-duediligence" class="card-title">PlanGym</h5>
        </div>
      </div>
      <div id="side-6" class="slide card">
        <a href="https://github.com/Hecti1008/Punch_d_aventures/tree/main/Punch%20d'aventures"><img class="card-img-top" src="<?php echo e(asset('img/Punch.png')); ?>"/> </a>
        <div class="card-body">
...
</html><?php /**PATH F:\DAM-DAW\RECUPERACION PROYECTO\DevChallenge1\Portafolio\Portafolio\resources\views/welcome.blade.php ENDPATH**/ ?>